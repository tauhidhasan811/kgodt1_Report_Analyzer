...
def calculate_documentation_quality(data):
    ...
    documentation_quality = (summary_total + pdpm_summary) / 100 * 100
...
def calculate_compliance_score(data):
    ...
    for risk in data["risk_flags"]:
        ...
        risk_scores.append((risk_total / 59) * 100)
    ...
    safety_pdpm_score = (safety_pdpm_total / 30) * 100
...
def calculate_risk(overall_score):
    if overall_score >= 75:
        risk_level = 'low'
    elif overall_score <75 and overall_score > 40:
        risk_level = 'medium'
...
def calculate_score(out_temp):
    ...
    risk_level = calculate_risk(overall_score=overall_score)
    data = {
